"""
Using the following code, Find the number of steps required to solve the 8 puzzle where
Initial state = 123
                456
                708
goal state = 123
...
class EightPuzzle:
    ...
    def solve(self, h):
        """Performs A* search for goal state. h(puzzle) - heuristic function, returns an integer """
